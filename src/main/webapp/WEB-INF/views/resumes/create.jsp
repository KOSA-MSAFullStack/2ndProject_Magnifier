...
<body>
    <div class="background">
        ...
        <div class="form-section">
            <input class="resume-title" type="text" placeholder="제목">
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                <input class="school-name" type="text" placeholder="학교명">
                <select class="graduate-status">
                    <option>졸업여부</option>
                    <option>졸업</option>
                    <option>중퇴</option>
                </select>
                <input class="enter-date" type="text" id="admissionMonth" placeholder="입학년월">
                <input class="graduate-date" type="text" id="graduationMonth" placeholder="졸업년월">
            </div>
        </div>
